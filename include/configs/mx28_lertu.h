/*
 ...
 ============================================================================
 */
#ifndef __CONFIGS_RTUIMX287_H__
#define __CONFIGS_RTUIMX287_H__
...
#define FAT_ENV_FILE		"leubootenv.bin"
#define CONFIG_ETHADDR		c0:e5:4e:02:00:00
#define CONFIG_ETH1ADDR		c0:e5:4e:02:00:01
#define CONFIG_IPADDR		192.168.2.55
...
#define CONFIG_FDTFILE		"imx28-m28evk.dtb"
#define CONFIG_HOSTNAME		lertu
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"mmcload="							\
		"run kernel_mmcload fdt_mmcload\0"			\
	"fdt_mmcload="							\
		"mmc rescan ; "						\
		"fatload mmc 0:2 ${fdt_addr_r} ${fdtfile}\0"		\
	/*"mmcload="*/							\
	"kernel_mmcload="						\
		"mmc rescan ; "						\
